...
GRR.del <- compute.GRR.matrix(GRR = "SKAT", genes.maf = Kryukov, n.case.groups = 2,
...
```{r}
x <- random.bed.matrix.GRR(genes.maf = Kryukov, size = c(1000, 500, 500), 
...
power.burden(alpha = 0.001, WSS = TRUE, CAST = TRUE, 
             ...
             genes.maf = Kryukov, select.gene = "R1", size = c(1000,500,500), 
