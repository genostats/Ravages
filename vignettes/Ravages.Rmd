...
#WSS 
burden.mlogit(x=x1, group=LCT.pop, burden="WSS", ref.level="CEU", alpha=0.05, 
              get.OR.value=TRUE)
...
burden.mlogit(x=x1, group=LCT.pop, burden="WSS", ref.level="CEU", alpha=0.05, 
              get.OR.value=TRUE, data=covar, formula = ~ sex)

#WSS using directly the score matrix computed previously
burden.mlogit(burden=WSS.score, group=LCT.pop, ref.level="CEU", alpha=0.05, 
              get.OR.value=TRUE)
```
