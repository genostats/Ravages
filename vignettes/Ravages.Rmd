...
# Filter SNPs with maf (computed on whole sample) < 0.025
...
# run burden test WSS, using the 1000 genome population as "outcome"
burden.mlogit(x1, LCT.pop, burden = "WSS", ref.level = "CEU")
