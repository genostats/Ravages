...
An example of this function and how to use it with SKAT is shown below. In this example, only 500 permutations are perfromed at maximum, but please use a more important value of perm.max to get more accurate estimations of p-values.
...
SKAT(x1, group=x1@ped$pop, Pi=Pi.matrix.LCT, perm.max = 500)
```
