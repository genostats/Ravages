...
// SKAT(const XPtr<matrix4> pA, LogicalVector which_snps, IntegerVector SNPgroup, IntegerVector ind_group, NumericMatrix Pi_, NumericVector W_)
//[[Rcpp::export]]
List skat(XPtr<matrix4> p_A, LogicalVector which_snps, IntegerVector region, IntegerVector group, NumericMatrix Pi, NumericVector weights, int A_target, int B_max) {
...
RcppExport SEXP skat(SEXP p_ASEXP, SEXP which_snpsSEXP, SEXP regionSEXP, SEXP groupSEXP, SEXP PiSEXP, SEXP weightsSEXP, SEXP A_targetSEXP, SEXP B_maxSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(skat(p_A, which_snps, region, group, Pi, weights, A_target, B_max));
