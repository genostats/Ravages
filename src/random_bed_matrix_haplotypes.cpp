...
// [[Rcpp::export]]
XPtr<matrix4> random_bed_matrix_haplotypes(NumericMatrix haplos, NumericMatrix freq, NumericVector size, int reps) {
...
RcppExport SEXP random_bed_matrix_haplotypes(SEXP haplosSEXP, SEXP freqSEXP, SEXP sizeSEXP, SEXP repsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(random_bed_matrix_haplotypes(haplos, freq, size, reps));
