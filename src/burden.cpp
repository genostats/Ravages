...
NumericMatrix burden2(matrix4 & A, int n_regions, IntegerVector region, NumericVector w1, NumericVector w2) { 
...
//[[Rcpp::export]]
NumericMatrix burden2(XPtr<matrix4> p_A, int n_regions, IntegerVector region, NumericVector w1, NumericVector w2) {
  return burden2(*p_A, n_regions, region, w1, w2);
}
...
RcppExport SEXP oz_burden2(SEXP p_ASEXP, SEXP n_regionsSEXP, SEXP regionSEXP, SEXP w1SEXP, SEXP w2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<matrix4> >::type p_A(p_ASEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type w1(w1SEXP);
    Rcpp::traits::input_parameter< NumericVector >::type w2(w2SEXP);
    rcpp_result_gen = Rcpp::wrap(burden2(p_A, n_regions, region, w1, w2));
    return rcpp_result_gen;
END_RCPP
}
